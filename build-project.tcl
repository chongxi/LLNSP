...
set_property "edif_extra_search_paths" "[file normalize "$util_dir"]" $obj
...
set_property STEPS.WRITE_BITSTREAM.TCL.PRE "$util_dir/showstopper.tcl" $obj
