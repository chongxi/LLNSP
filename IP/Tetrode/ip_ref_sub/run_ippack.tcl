...
set IPName      "ref_sub"
set Version     "1.0"
set DisplayName "Ref_sub"
set Revision    "1901151457"
...
set Interfaces {
    ...
    muar_stream_V_data_V {
        type "axi4stream"
        mode "master"
        port_prefix "muar_stream_V_data_V"
        has_tready "1"
        ports {
            TDATA 160
        }
...
## System Info
set user_parameters_list {clk_period 4.000000 machine 64 combinational 0 latency 5 II x}
...
set enable_xo_gen 0
set kernel_files {/disk0/Work/xike_hls_module/ref_sub/ref_sub.cpp}
if {$enable_xo_gen} {
