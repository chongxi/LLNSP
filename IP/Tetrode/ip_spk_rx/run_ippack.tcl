...
set Library     "hls"
set IPName      "spk_packet_rx"
set Version     "1.0"
set DisplayName "Spk_packet_rx"
set Revision    "1710022034"
set Description "An IP generated by Vivado HLS"
set Device      "kintex7"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "spk_packet_rx"
...
set Interfaces {
    ap_clk {
        ...
        buses "pre_in post_in time_stamp_V spk_out_stream_V_data_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    spk_out_stream_V_data_V {
        type "axi4stream"
        mode "master"
        port_prefix "spk_out_stream_V_data_V"
        has_tready "1"
        ports {
            TDATA 128
        }
...
## System Info
set user_parameters_list {clk_period 4.000000 machine 64 combinational 0 latency 4 II x}
...
set enable_xo_gen 0
set kernel_files {/disk0/Work/xike_hls_module/spkPack/rx_160ch/spk_packet_rx.cpp}
if {$enable_xo_gen} {
