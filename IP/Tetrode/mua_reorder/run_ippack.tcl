...
set Library     "hls"
set IPName      "mua_reorder"
set Version     "1.0"
set DisplayName "Mua_reorder"
set Revision    "1901202339"
...
set Interfaces {
    ...
    muao_stream_V_data_V {
        type "axi4stream"
        mode "master"
        port_prefix "muao_stream_V_data_V"
        has_tready "1"
        ports {
            TDATA 32
        }
...
## System Info
set user_parameters_list {clk_period 4.000000 machine 64 combinational 0 latency 39 II x}
...
set enable_xo_gen 0
set kernel_files {/disk0/Work/xike_hls_module/mua_reorder/mua_reorder.cpp}
if {$enable_xo_gen} {
