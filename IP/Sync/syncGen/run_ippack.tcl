...
set IPName      "syncGen"
set Version     "1.0"
set DisplayName "Syncgen"
set Revision    "1709251340"
...
set Interfaces {
    ...
    time_stream_V_sec_V {
        type "axi4stream"
        mode "slave"
        port_prefix "time_stream_V_sec_V"
        has_tready "1"
        ports {
            TDATA 16
        }
...
set enable_xo_gen 0
set kernel_files {/disk0/Work/xike_hls_module/syncGen/syncGen.cpp}
if {$enable_xo_gen} {
